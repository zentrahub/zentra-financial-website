      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 sm:px-10">
        ...
        <div className="flex items-center gap-6 sm:gap-8">
          <details className="group relative">
            <summary className="flex cursor-pointer list-none items-center gap-2.5 text-[0.66rem] font-normal tracking-[0.14em] text-fg uppercase [&::-webkit-details-marker]:hidden">
            ...
            <div className="absolute top-[calc(100%+1rem)] right-0 z-20 flex min-w-48 flex-col gap-4 border border-line bg-bg px-6 py-5">
              <Link
                href="/#expertise"
                className="text-xs font-normal tracking-[0.08em] text-fg-soft uppercase transition hover:text-fg"
              >
                {t.nav.expertise}
              </Link>
              <Link
              ...
              <ConsultationButton className="text-left text-xs font-normal tracking-[0.08em] text-fg-soft uppercase transition hover:text-fg">
                {t.nav.contact}
              </ConsultationButton>
              {/* TODO: point at the firm's TaxDome tenant URL once available */}
              <a
                href="#"
                className="text-xs font-normal tracking-[0.08em] text-fg uppercase transition hover:text-accent"
              >
                {t.nav.clientPortal}
              </a>
            </div>
