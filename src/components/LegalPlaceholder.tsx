...
export default function LegalPlaceholder({ title }: { title: string }) {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-24 sm:px-10">
      <p className="mb-4 text-[0.62rem] font-normal tracking-[0.2em] text-fg-soft uppercase">
      ...
      <Link
        href="/"
        className="mt-10 inline-block border-b border-fg pb-0.5 text-xs font-normal tracking-[0.08em] text-fg uppercase"
      >
